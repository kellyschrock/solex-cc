...
MAVLinkProcessor2 = function(logger, srcSystem, srcComponent) {
...
util.inherits(MAVLinkProcessor2, events.EventEmitter);

// If the logger exists, this function will add a message to it.
// Assumes the logger is a winston object.
MAVLinkProcessor2.prototype.log = function(message) {
    if(this.logger) {
        this.logger.info(message);
    }
}

MAVLinkProcessor2.prototype.log = function(level, message) {
    if(this.logger) {
        this.logger.log(level, message);
    }
}

MAVLinkProcessor2.prototype.send = function(mavmsg) {
...
MAVLinkProcessor2.prototype.bytes_needed = function() {
    ret = this.expected_length - this.buf.length;
    return ( ret <= 0 ) ? 1 : ret;
}

// add data to the local buffer
MAVLinkProcessor2.prototype.pushBuffer = function(data) {
    if(data) {
...
MAVLinkProcessor2.prototype.parsePrefix = function() {
    ...
    if( this.buf.length >= 1 && this.buf[0] != this.protocol_marker ) {
        ...
        //    this.have_prefix_error = true;
            throw new Error(`Bad prefix(${badPrefix}), expected ${this.protocol_marker}`);
...
MAVLinkProcessor2.prototype.parseLength = function() {
...
MAVLinkProcessor2.prototype.parseChar = function(c) {
...
MAVLinkProcessor2.prototype.parsePayload = function() {
...
MAVLinkProcessor2.prototype.parseBuffer = function(s) {
...
MAVLinkProcessor2.prototype.decode = function(msgbuf) {
...
module.exports = {mavlink, MAVLinkProcessor2};
